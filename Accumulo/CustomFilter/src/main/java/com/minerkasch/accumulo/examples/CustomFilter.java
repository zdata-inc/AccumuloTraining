...
public class CustomFilter extends Filter {
  ...
  public IteratorOptions describeOptions() {
    ...
    iterOpts.setDescription(
        "The LocationFilter allows you to " + "filter key/value pairs based on locations");

    // Add options to allow min and max value to be specified
    iterOpts.addNamedOption(
        CustomFilter.MAX_VALUE, "maximum value allowed (default is Long.MAX_VALUE)");
    iterOpts.addNamedOption(
        CustomFilter.MIN_VALUE, "minimum value allowed (default is Long.MIN_VALUE)");
